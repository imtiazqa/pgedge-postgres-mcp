...
```markdown
[![CI - Server](https://github.com/pgEdge/pgedge-nla/actions/workflows/ci-server.yml/badge.svg)](https://github.com/pgEdge/pgedge-nla/actions/workflows/ci-server.yml)
[![CI - CLI Client](https://github.com/pgEdge/pgedge-nla/actions/workflows/ci-cli-client.yml/badge.svg)](https://github.com/pgEdge/pgedge-nla/actions/workflows/ci-cli-client.yml)
[![CI - Web Client](https://github.com/pgEdge/pgedge-nla/actions/workflows/ci-web-client.yml/badge.svg)](https://github.com/pgEdge/pgedge-nla/actions/workflows/ci-web-client.yml)
[![CI - Docker Compose](https://github.com/pgEdge/pgedge-nla/actions/workflows/ci-docker-compose.yml/badge.svg)](https://github.com/pgEdge/pgedge-nla/actions/workflows/ci-docker-compose.yml)
```

...
- Command-line flags: `./bin/pgedge-mcp-server -http -addr :8080 -no-auth -db-host localhost -db-port 5432 -db-name mydb -db-user myuser -db-password mypass`
- Config file: Create a `pgedge-mcp-server.yaml` file with database connection parameters
